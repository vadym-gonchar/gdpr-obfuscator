python -m src.main '{"file_to_obfuscate": "s3://gdpr-ingestion-bucket/uk_student_records_1000.csv", "pii_fields": ["name", "email_address"]}'

python -m src.main '{"file_to_obfuscate": "s3://gdpr-ingestion-bucket/uk_student_records_1000.json", "pii_fields": ["name", "email_address"]}'

python -m src.main '{"file_to_obfuscate": "s3://gdpr-ingestion-bucket/uk_student_records_1000.parquet", "pii_fields": ["name", "email_address"]}'
